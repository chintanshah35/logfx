...
|---------|---------|-------------|
| [logfx](./packages/logfx/README.md) | 1.0.0 | Core logging library (zero dependencies) |
| [logfx-otel](./packages/logfx-otel/README.md) | 1.0.0 | OpenTelemetry integration |
| [logfx-sentry](./packages/logfx-sentry/README.md) | 1.0.0 | Sentry error tracking integration |
| [logfx-datadog](./packages/logfx-datadog/README.md) | 1.0.0 | Datadog APM integration |
| [logfx-elasticsearch](./packages/logfx-elasticsearch/README.md) | 1.0.0 | Elasticsearch integration |
| [logfx-cloudwatch](./packages/logfx-cloudwatch/README.md) | 1.0.0 | AWS CloudWatch Logs integration |
| [logfx-google-cloud](./packages/logfx-google-cloud/README.md) | 1.0.0 | Google Cloud Logging integration |
| [logfx-azure](./packages/logfx-azure/README.md) | 1.0.0 | Azure Monitor Log Analytics integration |
| [logfx-slack](./packages/logfx-slack/README.md) | 1.0.0 | Slack webhook integration |
| [logfx-loki](./packages/logfx-loki/README.md) | 1.0.0 | Grafana Loki integration |
| [logfx-papertrail](./packages/logfx-papertrail/README.md) | 1.0.0 | Papertrail integration |
| [logfx-splunk](./packages/logfx-splunk/README.md) | 1.0.0 | Splunk HEC integration |
| [logfx-honeycomb](./packages/logfx-honeycomb/README.md) | 1.0.0 | Honeycomb Events API integration |
| [logfx-logtail](./packages/logfx-logtail/README.md) | 1.0.0 | Logtail (Better Stack) integration |
